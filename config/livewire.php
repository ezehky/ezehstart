...
return [
    ...
    */
    ...
    'payload' => [
        ...
        // The email builder's own nesting bottoms out one level past the default: a
        // Socials block sitting inside a column, editing its own custom_links list,
        // produces "blocks.0.data.columns.1.blocks.1.data.custom_links.0.platform" —
        // 11 segments. Raised just enough to cover that legitimate shape.
        'max_nesting_depth' => 12,   // Maximum depth of dot-notation property paths
