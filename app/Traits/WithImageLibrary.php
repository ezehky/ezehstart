...
trait WithImageLibrary
{
    ...
    public function newFolder(): void
    {
        ...
        $this->folder_visibility = ImageVisibilityEnum::PRIVATE->value;
    ...
    public function saveFolder(): bool
    {
        $this->validate([
            ...
            'folder_visibility' => ['required', Rule::enum(ImageVisibilityEnum::class)],
            'folder_visible_to_role' => ['nullable', Rule::enum(UserRoleEnum::class)],
        ]);

        $visibility = ImageVisibilityEnum::from($this->folder_visibility);
