...
<flux:field class="space-y-2">
	...
	<div
		x-data="{ uploading: false, progress: 0, fileName: @js($selected) }"
	...
	>
		<input
			...
			{{ $attributes->merge(['accept' => '.json,.csv,application/json,text/csv']) }}
		/>
		...
		>
			<div class="flex size-9 shrink-0 items-center justify-center rounded-md bg-zinc-200 text-zinc-600 dark:bg-white/10 dark:text-zinc-300">
